-- chunk 2/14 questions 40 (산업안전기사)
...
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('cc964b0f-da21-baa6-1272-2d41e8663138', '280fd133-41b7-43fd-c673-9341b5a964a1', '④ 침투식', '정답 ④. «m 초음파탐상법의 종류로는 투과법. 펄스반사법, 공진법 등이 있다. E 8I', array['산업안전기사','2025-2'])
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('03a7115b-5dd9-c00f-93f2-e135ba9dde7a', '01cebf14-5fc7-2abc-f2b0-5272f0bf32a4', '③ 플런저식', '정답 ③. KOI 압력방출장치의 종류 중추식(추식), 지렛대식(레버식). 스프링식(가장 많이 사용)', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('ad42eb0a-6a53-e142-febb-642404520e91', '6ac30333-eab8-5ec9-124e-fcaa43ee278a', '② 슬라이드 행정길이가 5이mm] 이상. 슬라이드 행정수', '정답 ②. 가 200CSPM] 이하 «!EM 수인식 방호장치의 설치기준 슬라이드 행정수가 100[SPM] 이하. 행정길이가 50[mm] 이상의 것에 사 용한다', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('2556e0dd-0831-e8e2-a811-ec1d324e28e4', '0f911bd6-a7e4-7e8d-171a-f8928717a219', '② 밀링', '정답 ②. KIH 밀링작업 시 안전대책 • 밀링작업에서 생기는 칩은 가늘고 예리하며 부상을 입히기 쉬우므로 보 안경을 착용한다. • 칩은 기계를 정지시킨 후 브러시 등으로 제거한다. • 강력절삭을 할 때는 일감을 바이스에 깊게 물린다. • 손이 말려 들어갈 위험이 있는 장갑을 착용하지 않는다. E S1', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('46dff958-aa24-0680-d656-4f5232e3a77c', '9255cdc8-3646-a1d8-0c2c-196d846df3dc', '④ 전력퓨즈', '정답 ④. K 피 누전차단기 구성요소 영상변류기. 누전검출부. 트립코일. 차단장치 및 시험장치 1 아UPTER 02 감전재해 및 방지대책 07', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('7396aea2-db0c-2f9a-80c2-1b7360da18c1', 'dbec471d-d9b6-a7a8-ea64-bd79b7ce2f61', '① 스유 오', '정답 ①. K 정전유도전압 v a으구 xe Ui 十 U2 등가회로 Ci： 송전선과물체 간의 정전용량 G： 물체와 대지 간의 정전용량 즈M： 인체저항 /正: 인체와 대지 간의 접촉저항 7?0： 물체의 대지절연저항 E： 송전선의 대지전압 V： 정전유도전압', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('744fc568-b131-32b4-6b00-0eeb7f368245', '27d71191-7bb9-6b07-94fd-96f2914b3172', '② 후드의 개구부 면적은 가능한 한 크게 할 것', '정답 ②. 할것 MfcMM 후드（Hood） 인체에 해로운 분진 등을 배출하기 위하여 설치하는 국소배기장치의 후드 는 다음의 기준에 맞도록 하여야 한다. • 유해물질이 발생하는 곳마다 설치할 것 • 유해인자의 발생형태와 비중. 작업방법 등을 고려하여 해당 분진 등의 발산원을 제어할 수 있는 구조로 설치할 것 • 후드 형식은 가능하면 포위식 또는 부스식 후드를 설치할 것 • 외부식 또는 리시버식 후드는 해당 분진 등의 발산원에 가장 가까운 위 치에 설치할 것 1', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('6d9fe8ea-adeb-02dc-ce55-3099f0b100c0', 'c68b9ad9-3ea8-2f9c-aff1-db4b9673ece7', '① 2.44', '정답 ①. 떼 혼합가스의 폭발하한계 r V1 十 V2H------1" Vn 1十2十2 r 1 L 하+야+ + 匕 丄+2+2 2-44。1物 여기서, L： 혼합가스의 폭발하한계 [vol%] Ln‘ 각 성분가스의 폭발하한계 [vol%] K： 각 성분가스의 부피 비율 [vol%] 1', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('16c01ffd-0da3-2b89-8e37-e2b71f382f7b', '6d4328da-b2af-08b7-f219-134a39919a63', '① e2日4匕허', '정답 ①. KEB 2402는 구성 원소 중 C 2개. F 4개. C1 0개. Br 2개. I 0개이다. 따라서 Halon 2402의 화학식은 C2F4Br2이다. K니이Bi', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('28f22818-2011-0409-4fc7-d50db6b5acc5', 'f264975a-e6b7-a11c-dd8c-17e24cc796d0', '② 작업발판의 재료는 뒤집히거나 떨어지지 않도록 하나', '정답 ②. 는것을 사용한다. 3 작업발판의 설치기준（비계 높이 2[m] 이상인 작업장소） • 발판재료는 작업할 때의 하중을 견딜 수 있도록 견고한 것으로 할 것 • 작업발판의 폭은 40[cm] 이상으로 하고, 발판재료 간의 틈은 3[cm] 이 하로 할 것. 다만. 외줄비계의 경우에는 고용노동부장관이 별도로 정하 는 기준에 따른다. • 추락의 위험이 있는 장소에는 안전난간을 설치할 것 • 작업발판의 지지물은 하중에 의하여 파괴될 우려가 없는 것을 사용할 것 • 작업발판 재료는 뒤집히거나 떨어지지 않도록 둘 이상의 지지물에 연결 하거나 고정시킬 것 • 작업발판을 작업에 따라 이동시킬 경우에는 위험방지에 필요한 조치를 할것 1', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('f96ed21d-921f-b8ac-887e-9b4c2eefa4a0', 'a2383869-a20c-d785-5245-af2fe900e4da', '① 안전관리를 위한 교육자료', '정답 ①. HB 건설공사 유해위험방지계획서 제출 시 첨부서류 • 공사 개요서 • 공사현장의 주변 현황 및 주변과의 관계를 나타내는 도면（매설물 현황 포함） • 전체 공정표 • 산업안전보건관리비 사용계획서 • 안전관리 조직표 • 재해 발생 위험 시 연락 및 대피방법 바^I', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('ef32cc9d-af4b-0750-942f-59db3b477067', 'b8d728c4-ffb1-1edc-8342-3cd1cf7ba57e', '② 안전에 대한 욕구', '정답 ②. 매슬로우(Maslow)의 욕구위계이론 © 제1단계: 생리적 욕구 © 제2단계: 안전의 욕구 © 제3단계: 사회적 욕구(친화 욕구) @ 제4단계 : 자기존경의 욕구(안정의 욕구 또는 자기존중의 욕구) @ 제5단계 : 자아실현의 욕구(성취욕구) 1', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('92d4f185-f569-de19-2c6d-d748a12ce11d', '5f5dc1d2-ac7c-be0f-1fe3-4d1e28e44b84', '③ 예비위험분석(PHA； Preliminary Hazard Analysis)', '정답 ③. 표보 M 예비위험분석(PHA； Preliminary Hazards Analysis) 시스템 내의 위험요소가 얼마나 위험상태에 있는가를 평가하는 시스템안 전 프로그램의 최초단계(시스템 구상단계)의 정성적인 분석 방식이다. 1', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('f735dcf8-94d7-f398-4c39-f212e97d149b', 'f83054ac-6c06-a37d-b371-949a222baf8b', '④ Technology Assessment', '정답 ④. MWli 테크놀로지 어세스먼트(Technology Assessment) 안전성 평가 중 기술 개발과정에서의 효율성과 위험성을 종합적으로 분석. 판단하는 프로세스이다. 1', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('770cf0b3-c18f-0148-1261-1c2a0c16fc7e', '31d4c176-445c-8c56-6bb7-0563f57bae8c', '③ 96[mm]', '정답 ③. KOI 위험점이 전동체인 경우 개구부의 간격 y 6+0.1X 6+0.1 x 900 96 [mm] 여기서. /： 개구부의 간격[mm] X： 개구부에서 위험점까지의 최단거리[mm] 洪 전동체의 경우 개구부의 간격 공식이 X<760[mm]일 때만 유효하나 본 문제에서는 X 900[mm] 조건에서도 해당 공식을 적용하여 계산 한 경우를 정답으로 하고 있습니다. 실제 ISO 기준으로는 760<X < 1.000일 때 y는 표준값 100[mm｝을 적용하여야 합니다. 1', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('eee6d358-7d1e-350f-d9f6-424b11f6bdbc', '61fbb522-fd6e-9057-7fb7-fd18bb104be6', '② 85[ms]', '정답은 ② 입니다', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c42da96a-94c9-185f-7dc6-98e5fbed82b6', '3b245266-9997-fbb4-bfab-53944a92b070', '④ 순간적 외력에 의한 파손', '정답 ④. W 순간적 외력에 의한 파손은 우발고장에 해당한다. 마모고장（증가형） 설비 또는 장치가 수명을 다하여 생기는 고장이다. 1 SUBJECT 02 인간공학 및 위험성평가 • 관리', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('4ddf9f0a-c9b0-e253-3a5e-3a15c9588f2f', '6c7f819e-d63e-046b-d9a3-5a63e55773b7', '② 일감 절삭 중 치수를 측정한다.', '정답 ②. mi 밀링작업 시 일감 또는 부속장치 등을 설치하거나 제거할 때 또 는 일감을 측정할 때에는 반드시 정지시킨 다음에 작업한다. E IE1 아MPTER 03 공작기계의 안전 06', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('104187d2-bb05-3a36-15d8-9d24ad3eedf1', '12ca526f-d8ef-63b1-f2a3-60822527bc50', '② 27.2', '정답 ②. W vr z27?7" g뜨X1(T3)2X1.OOOT (1652x 10-6)X1.000 27.2[J] 여기서. 形: 위험한계에너지U] /： 심실세동전류[A] 正: 인체저해오] T： 통전시간[s] 1 아1APTER 02 감전재해 및 방지대책 06', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('989ebd1e-1bdb-93cf-4395-d9f7fb7bde4b', 'dded54cf-8168-b5e6-56f4-8db700b762e4', '② 3O[mA] 이하, 0.03초 이내', '정답 ②. KS 감전보호용누전차단기 • 정격감도전류 30[ ] 이하. 동작시간 0.03초 이내 • 정격전부하전류가 50[A] 이상인 경우. 정격감도전류 200[ ] 이하, 동 작시간 0.1 초 이내 1', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('39dd0e98-ff1e-18fc-a72d-f39c879792b6', '8901265c-a97f-d2fc-2ad8-ecf7a301a924', '③ 잔류전하 방전', '정답 ③. K3 커패시터는 전기를 저장하는 장치이므로 방전코일이나 방전기구 등을 이용하여 잔류전하의 방전을 주의 깊게 조치하여야 한다', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('900126fb-65dc-e777-a395-bc7a1b18ad41', '7210db9b-70bf-792d-6294-ceca045496db', '② 1,733', '정답 ②. Kmi 송풍량은 회전수와 비례한다. 옹 쓰에서 M 응 X N, 쓰 X 1.300 l,733[rpm] 여기서. Q： 송풍량 N： 회전수', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('45fb007a-e166-0e6d-a4f0-95bc0bc9cf21', 'b2bb6a21-edac-69e8-ed17-4e241f7a1fc4', '① 심각한 응급환자 발생 시 신속히 응급처치 후 119 등에', '정답 ①. 고 편한 자세로 안정을 취하도록 한다. Km 심각한 응급환자 발생 시 섣부른 응급처치보다는 빠른 신고가 우 선이므로 신속히 119 등에 전화하여 도움을 청한다. E早', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('4b1b127e-b887-13b8-d7d2-a7c948ecfabc', 'ce2a6243-69e7-fbb3-9492-50cfa6ebee9f', '② 40', '정답 ②. K 삐 부식성 염기류 농도가 40[%] 이상인 수산화나트륨, 수산화칼륨. 그 밖에 이와 같은 정도 이상의 부식성을 가지는 염기류이다. 1', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
