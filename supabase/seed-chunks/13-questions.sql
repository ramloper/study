-- chunk 13/14 questions 40 (산업안전기사)
...
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('906f230c-201f-12a8-ddc5-eea99e3735a4', 'c07e6026-f4c5-a301-035c-fd0c802966a3', '① 자유분방, 비판금지 , 대량발언, 수정발언', '정답 ①. MW 브레인스토밍(Brain Storming) • 비판금지: “좋다, 나쁘다’’ 등의 비평을 하지 않는다. • 자유분방: 자유로운 분위기에서 발표한다. • 대량발언 : 무엇이든지 좋으니 많이 발언한다. • 수정발언: 자유자재로 변하는 아이디어를 개발한다.(타인 의견의 수정 발언) 1', array['산업안전기사','2019-2'])
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('f4e2c0e7-de61-5e9d-c9d2-be628bf97d5c', '0e438e8d-de16-183c-d057-a14be39bc359', '② 시간에 따른 원인 분석', '정답 ②. W FTA의 기대효과 • 사고원인 규명의 간편화 • 사고원인 분석의 일반화 • 사고원인 분석의 정량화 • 노력, 시간의 절감 • 시스템의 결함 진단 • 안전점검 체크리스트 작성', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('1eb28774-2793-58fe-6cea-6b8c66a57f3a', 'c16a0361-d7a9-b99f-6e2c-497bca151e1e', '③ 3OO[kW]', '정답 ③. B 전기 계약용량이 300[kW] 이상인 사업의 사업주는 해당 제품의 생산 공정과 직접적으로 관련된 건설물 • 기계 • 기구 및 설비 등 전부를 설 치 • 이전하거나 그 주요 구조부분을 변경할 때는 유해위험방지계획서를 제출하여야 한다', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('fb2680cd-d035-95e3-fc28-723947f3b4e2', 'ac2bbd69-0b0e-09f7-3b7c-773544fe7d0d', '③ 차량 등의 운송설비업', '정답 ③. KOi 차량 등의 운송설비업은 적용대상이 아니며, 차량 등의 운송설비 는 유해하거나 위험한 설비로 보지 않는다. 공정안전보고서의 제출 대상 • 원유 정제처리업 • 기타 석유정제물 재처리업 • 석유화학계 기초화학물질 제조업 또는 합성수지 및 기타 플라스틱물질 제조업 • 질소 화합물. 질소질 화학비료 제조업 • 복합비료 제조업 • 화학 살균 . 살충제 및 농업용 약제 제조업(농약 원제 제조만 해당) • 화약 및 불꽃제품 제조업 W11S1 SUBJECT 05 화학설비 안전관리', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('5dcd700f-4d3c-2fed-ceae-9768939d3d87', '3cca0448-b9db-dc15-e661-1cf84dadd244', '③ 황색', '정답 ③. a 고압가스용기의 도색 • 액화석유가스: 밝은 회색 • 수소: 주황색 • 아세틸렌: 황색 • 액화암모니아: 백색 • 액화염소: 갈색 •산소: 녹색 • 기타가스: 회색 ! SUBJECT 05 화학설비 안전관리', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('2dcb8f8b-e656-9957-674b-dfde22917c02', '2168b839-ed31-a1c1-9250-4715fd3bf6d0', '② 30', '정답 ②. KOI 안전전압 회로의 정격전압이 일정 수준 이하의 낮은 전압으로 절연파괴 등의 사고 시에도 인체에 위험을 주지 않는 전압을 말하며, ’ 산업안전보건법령」에서 30[V]로 규정하고 있다. fc! ji 아UPTER 02 감전재해 및 방지대책 06', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('a0de241b-e178-dd65-c73e-28bb59696586', '5ae1537a-8f3e-662e-5ce6-076039682a01', '④ 차단: ® —- ©—®, 투입: ©—®—Q)', '정답 ④. HOI 유입차단기의 작동(투입 및 차단＞순서 • 차단순서: © —@-@ • 투입순서: @ —®—•©', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('74c2c845-0f13-f5f0-4aac-6325d2addd0e', '92a50a4e-efc5-3ad6-2d06-4cd9f00f4647', '① 2.51', '정답 ①. 짜 혼합가스의 연소하한값 7• — 자i+VJ-----H<, _ 1+2.5+0.5 丄,+z리 TT+^J+^7 여기서, L： 혼합가스의 연소하한갮vol%] Lw： 각 성분가스의 연소하한갮vol%] V,,： 각 성분가스의 조성[vol%] 1', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('51997e93-fd8c-9458-d932-f0b27c0acdad', 'e83e1193-4319-51b6-b545-3daa79f4a9f4', '④ 설비점검 - 검사 및 보수계획, 유지계획 및 지침서', '정답 ④. KOi 는 안전운전계획에 포함하여야 할 세부내용이다. 바遞%1 아UPTER 04 화공 안전운전 • 점검 2019년 2회 기출문제 • 551 08', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('ce479f27-4677-512a-6b16-c20f68719125', 'a7958b93-11b1-3c99-e439-a470e59b3c89', '② 191', '정답은 ② 입니다', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('f9c64d7d-d75e-a113-8f40-e8b6375bb3e6', '9100c97f-0c0e-f0de-eae1-6286a0f4bfec', '③ 10.4', '정답 ③. K3 부탄의 완전연소반응식 C4Hlo 十 6.502 —* 4CO2 十 5H20 최소산소농도（Cm） 폭발하핸%] X 懲소"아흐、 연소가스 mol 수 1.6 x 윽§_ io.4[vol%] 1', array['산업안전기사','2019-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('e1a1dbf6-3e22-77b6-18d7-210a3ae9e424', '25ebed85-62b5-aeeb-7388-56ae2d0e7669', '④ 수강자 개개인의 학습진도를 조절할 수 있다.', '정답 ④. na 강의법은 다수의 수강자를 대상으로 동시에 교육을 진행하기 때 문에 개개인의 학습진도를 조절할 수 없다', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('d7b0bb0d-5f2c-fbb1-6fc3-2e6a813eb3e8', '32548549-a429-5994-8214-f95a78c204b0', '② 기초교육', '정답 ②. 3 기초교육은 안전교육의 3단계에 해당하지 않는다. 안전교육의 3단계 0 1단계: 지식교육 ©2 단계: 기능교육 ©3단계: 태도교육 1 아1APTER 05 안전보건교육의 내용 및 방법', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('9310f824-9ca5-ce7c-85e8-f84e01d04014', 'a80e8b69-98ba-ee58-43bf-b076d7a2c03c', '③ 원인결정', '정답 ③. 3 위험예지훈련의 추진을 위한 문제해결 4단계 0 1라운드: 현상파악(사실의 파악)-어떤 위험이 잠재하고 있는가? © 2라운드: 본질추구(원인조사)-이것이 위험의 포인트이다. © 3라운드: 대책수립(대책을 세운다)-당신이라면 어떻게 하겠는가? (D 4라운드: 목표설정(행동계획 작성)-우리들은 이렇게 하자! 테', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('efffb9d0-bf9f-9879-9ba6-c294787400f1', 'b86aa643-2ea9-591b-b0bd-f7fada1e4afe', '③ Media', '정답 ③. 3 4M 분석기법（휴먼에러의 배후요인） • 인간（Man； 자기 자신 이외의 다른 사람）: 잘못된 사용. 오조작, 착오, 실수, 불안심리 • 기계（Machine； 기계 • 기구• 장치 등의 물적인 요인）: 설계 • 제작 착오, 재료 피로 - 열화, 고장, 배치 • 공사 착오 • 작업매체（Media； 인간과 기계를 연결시키는 매개체）: 작업정보 부족- 부적절, 작업환경 불량 • 관리（Management； 안전에 관한 법규. 규칙 등）: 안전조직 미비, 교 육 • 훈련 부족. 계획 불량, 잘못된 지시 리', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('517330ef-d07e-de11-8559-873d321c86aa', '53af00d1-e36b-04aa-6dce-155d2383a01c', '③ 작업공정의 유해 • 위험과 재해 예방대책에 관한 사항', '정답 ③. 9 ©. ©는 근로자와 관리감독자의 채용 시 및 작업내용 변경 시 교 육내용이고. 는 근로자의 채용 시 및 작업내용 변경 시 교육내용이다. 폐', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c3784e8b-f95d-0f51-013b-ee58460c2b51', '1ed824ca-d9fa-7f80-8590-a7c5faf243bc', '② 30[%]', '정답 ②. M^M 안전보건표지의 제작 • 표시내용을 근로^가 빠르고 쉽게 알아볼 수 있는 크기로 제작하여야 *E • 표지 속의 그림 또는 부호의 크기는 안전보건표지의 크기와 비례하여야 하며. 안전보건표지 전체 규격의 30[%] 이상이 되어야 한다. • 쉽게 파손되거나 변형되지 않는 재료로 제작하여야 핸다. • 야간에 필요한 안전보건표지는 야광물질을 사용하는 등 쉽게 알아볼 수 있도록 제작하여야 한다. 1', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('b76857b7-3d16-f99d-7127-a5e27ab06aeb', 'c9ea03f4-8fdf-4225-9565-704ccacea49f', '④ EP-2', '정답 ④. KOi 방음용 귀마개 또는 귀덮개의 종류 - 등급 종류 등급 기호 성능 1 종 EP-1 저음부터 고음까지 차음하는 것 귀마개 주로 고음을 차음하고 저음（회화음영역）은 차음하지 2 종 다3-2 않는것 귀덮개 -', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('6efbbc52-51d7-89e7-a569-94cbc8105640', 'b69b4033-ba15-b7ff-e24a-5cdbe22b7ea3', '④ 터널 건설 공사', '정답 ④. a 깊이가 io[m] 이상인 굴착공사. 최대 지간거리가 50[m] 이상인 다리의 건설 등 공사. 지상높이 31[m] 이상인 건축물 건설 등 공사가 유해 위험방지계획서 제출대상 공사이다. t 뽀I 아MPTER 01 산업재해예방 계획 수립 02', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('02ebfe1a-e3a0-fc0f-c3a3-09a73e848b55', 'e0433f61-d44c-b0f4-b5d7-8020326c538c', '② 보전예방', '정답 ②. 푸:亞仕 보전예방（Maintenance Prevention） 설비를 새로이 계획 • 설계하는 단계에서 보전 정보나 새로운 기술을 채용 하여 신뢰성. 보전성, 경제성. 조작성, 안전성 등을 고려하여 보전비나 열화 손실을 적게 하는 활동이다. tW面', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c9c5b638-72b0-bc5e-e10c-3eb4b2b935c6', 'e5aede1b-31d5-28df-5971-df17d352ce0d', '③ 실효온도', '정답 ③. »*己 실효온도(Effective Temperature, 감각온도, 실감온도) 온도. 습도. 기류 등의 조건에 따라 인간의 감각을 통해 느껴지는 온도로 상대습도 100[%]일 때의 건구온도에서 느끼는 것과 동일한 온도감이다. 바遞聞', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('26f42b86-d194-7699-34fa-144c728f7830', '6d458476-fdca-de3a-b31a-234d902a82b5', '③ 144[분]', '정답 ③. 1휴식시간 산소 1[L] 당 에너지소비량은 5[kcal] 이다. 따라서 작업 중에 분당 산소소비량이 1.3[L/min]이라면 작업의 평균에너 지는 1.3[L/min] x 5[kcal/L] 6.5[kcal/min] 이다. 60（E—5） 60〉〈（6.5—5） 휴식시간 7? 18분 E—1.5 6.5 — 1.5 여기서. £’： 작업의 평균 에너지소비량[kcal/min] 5： 평균 에너지 소비량 상핸kcal/min] 1시간당 18분의 휴식시간을 부여하여야 하므로 근로시간 8시간 중 18 x 8 144분이 휴식시간으로 포함되어야 한다. 1', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('bbf0f079-be09-0021-f3c1-c5f78cd41c9e', '990c6801-30a4-3c15-feca-8b882cc3ae51', '② 조합 AND 게이트', '정답은 ② 입니다', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('627e7076-a493-cb6b-28b1-b0bf8c4a270c', '5282fe22-26c4-8d1d-696a-ab2e8a930864', '② 2', '정답 ②. 3 사업주는 바닥으로부터 짐 윗면까지의 높이가 2[m] 이상인 화물 자동차에 짐을 싣는 작업 또는 내리는 작업을 하는 경우에는 근로자의 추 가 위험을 방지하기 위하여 해당 작업에 종사하는 근로자가 바닥과 적재함 의 짐 윗면 간을 안전하게 오르내리기 위한 설비를 설치하여야 한다. 1 SUBJECT 06 건설공사 안전관리', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('bea7484e-d12c-46f2-613f-c86f605fdab0', '4adecda5-9d8d-58d0-5963-cb7e9928e473', '② 내화물', '정답 ②. KOI 전기화재의 원인 발화원. 착화물. 출화의 경과＜발화형태）', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('a41e7977-b1d5-6db6-a716-d0701a1da423', 'a075ad2a-8fc4-5479-e000-809c912db43c', '④ ACB', '정답 ④. 두!gM 기중차단기(ACB； Air Circuit Breaker) 차단기가 트립되었을 때 발생하는 아크를 압축된 공기로 제거하는 차단기 로서 회로의 개폐나 단락사고에 의한 단락전류 등으로부터 전로를 보존 한다. 오求 H 설 VCB(Vacuum Circuit Breaker)： 진공차단기 (2)MCCB(Molded Case Circuit Breaker)： 배선용 차단기 (3)OCB(Oil Circuit Breaker): 유입차단기 1', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('054abc01-a903-4263-c005-a0db01491072', '7c4aeac8-7d69-aca7-a879-0fdb128a7812', '② 하한값: 39.6, 상한값: 1,395', '정답 ②. Emi 이상기체 상태방정식에 의해 20[℃]. 대기압 하에서 기체 분자 1 몰은 약 24[L]이다. nRT 1x0.082x(273+20) V ---------------------------- 24[L」 이황화탄소의 분자 1몰은 76.1[g]이므로 20[℃], 대기압 하에서 이황화탄 소는 1[L]당 76.14*24 3.17[g]이다. • 폭발하한값 1.25[vol%｝는 혼합가스 1[L] 중 이황화탄소 1.25x10 2 [L]가 있는 것을 의미하고. 이황화탄소 1.25 x l(r2[L]는 3.17 x (1.25 x 10-2) 3.96 x 10-2[g] 이다. 따라서 폭발하한값 1.25[vol%]는 3.96〉＜l(r2[g/L] 39.6[mg/L]로 나타낼 수 있다. • 폭발상한값 44[vol%]는 혼합가스 1[L] 중 이황화탄소 0.44[L]가 있는 것을 의미하고, 이황화탄소 0.44[L]는 3.17 x 0.44 1.395[g]이다. 따라서 폭발상한값 44[vol%｝는 1.395[g/L] l,395[mg/L]로 나타낼 수 있다. 1', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('18638906-2e39-9557-2b5e-7664034e5333', '71bff625-b99f-c99b-ab80-da6390943212', '② 농도 4이%]인 인산', '정답 ②. 3 부식성 산류 • 농도가 20[%] 이상인 염산, 황산. 질산. 그 밖에 이와 같은 정도 이상의 부식성을 가지는 물질 • 농도가 60[%] 이상인 인산, 아세트산, 불산, 그 밖에 이와 같은 정도 이 상의 부식성을 가지는 물질', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('470abd0e-2399-90cc-2d91-ce3fcff124ae', '46ae555e-d8f4-1302-f3b6-2b3dc3634651', '① 1,100', '정답 ①. 누W Burgess—Wheeler의 법칙 포화탄화수소계의 가스에서는 폭발하한계의 농도 Mvol%]와 그의 연소 열 아 [kcal/mol]의 곱은 일정하다. 入〉＜ ⑦느1,100(일정) 1', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('9487b1e9-437d-8724-9575-2457dc1e6581', '44e81ec3-715f-82be-9b9f-ed19cfbab2e0', '① 2.2', '정답 ①. KOI 혼합기체의 폭발하한계 디에틸에테르와 에틸 알코올이 3 : 1로 혼합되 어 있으므로 디에틸에테르의 부피비를 75[vol%], 에틸알코올의 부피비를 25[vol%]로 두고 다음 식을 푼다. 후i+꾸z+-+T心 — 75+25 L~ V^v.,, 75 , 25 —2.2LVOU」 TT+T：+''"+L2 U+I7', array['산업안전기사','2019-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
