...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('4bc42807-8b33-92ae-b987-6a7ca25a1a54','6d09b620-05c2-00de-3ff1-aab9e847a88f','③ 고정배선에 접속된 전기기계 • 기구중 사용전압이 대지','정답 ③. 휴대형 전동기계 • 기구의 노출된 비충전 금속체 KOI 고정배선에 접속된 전기기계 • 기구 중 사용전압이 대지전압 150[V]를 넘는 비충전 금속체가 접지대상이다. WBI',array['산업안전기사','2020-4'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('c004b557-c3da-adce-dd26-3d7e0bb0bc45','698d147f-8788-8d39-9162-780bbe14f00e','② 30[mA] 이하, 0.03초 이내','정답 ②. 감전보호용누전차단기 • 정격감도전류 30[ ] 이하, 동작시간 0.03초 이내 • 정격전부하전류가 50[A] 이상인 경우, 정격감도전류 200[ ] 이하, 동 작시간 0.1 초',array['산업안전기사','2020-4'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('e90fc7c0-95ff-27b4-92e8-454c9ba6d26c','0d2898c5-94a3-12a8-1ddc-7c24ef4c9026','① 99.95[%] 이상','정답 ①. 여과재 분진 등 포집효율 염화나트륨(rw) 및 형태 및 등급 파라핀 오일 (Paraffin oil) 시헴%] 특급 99.95 이상 분리식 1 급 94.0 이상 2 급 80.0 이상 E I81',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('b68def81-bfd4-7439-0236-123c1cbc53be','4ee9cdb4-0c9c-df43-3cfe-7a7492069e5e','④ 산소농도 측정 및 작업환경 에 관한 사항','정답 ④. 산소농도 측정 및 작업환경 에 관한 사항',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('92929f3d-bb7c-536f-4109-c97d8f3ce4ff','bd6d3750-03ac-d7a5-5975-04cf0474f94b','③ 작업관리','정답 ③. 에너지 소비량에 영향을 미치는 인자 작업방법. 작업자세. 작업속도. 도구설계 SUBJECT 02 인간공학 및 위험성평가 관리',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('f9daf3d2-b25c-b2d3-bbc2-ea4ced2ac82e','068c4d4f-63f7-0478-56ed-ccee8794dcb1','② 영구 일부노동 불능','정답 ②. 영구 일부노동 불능',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('d3724aaf-6a61-2b52-f64f-908bdb92038c','586921ea-8434-dce6-35c3-c21440166564','④ 석면취급 •해체 작업장','정답 ④. 석면취급 •해체 작업장',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('ba1ec92b-e263-86ae-4634-8f399e971050','007081b6-60ef-29de-a5fb-7a59587a3d6a','④ 시스템의 목표와 성능명세 결정','정답 ④. 시스템의 목표와 성능명세 결정',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('b129347c-539d-745c-91e3-73a8c97befab','38f29e28-7012-6d36-5451-5ed09bed59b9','④ 재결정온도','정답 ④. 재결정온도',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('559fad81-9c84-85d1-233b-716002b1143e','21338aad-3360-2756-0b29-db175d925c5e','③ 용접을 할 때에만 용접기의 주회로를 개로（OFF）시킨다.','정답 ③. 용접을 할 때에만 용접기의 주회로를 개로（OFF）시킨다.',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('af12400d-7fb6-5cd0-b831-a78244b86d59','6b224782-7ded-3c7f-758d-8bb4b7c150a6','② 25.54','정답 ②. 25.54',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('cfc076e9-d871-cd39-a8cc-0bd63b225fd1','27ad132d-544e-df92-e3f2-a520977b11bc','② 건립작업에 다소 지장이 있다 하더라도 수목은 제거하','정답 ②. 건립작업에 다소 지장이 있다 하더라도 수목은 제거하',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('33cfcf2e-aee8-52c9-4c39-1cd9ad54bd66','62464274-7fdd-ecb8-3db9-e3ce4dc092db','② 최대 지간길이가 50[m] 이상인 교량건설 등 공사','정답 ②. 최대 지간길이가 50[m] 이상인 교량건설 등 공사',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('ad027495-d2c8-daf1-be41-ba71b69a9e5e','216a3790-6814-41af-626a-0d2a98c9b197','② N치가 4〜10일 경우 모래의 상대밀도는 매우 단단한','정답 ②. N치가 4〜10일 경우 모래의 상대밀도는 매우 단단한',array['산업안전기사','2019-1'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
