-- chunk 7/14 questions 40 (산업안전기사)
...
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c32667d3-aea5-1f6a-c372-4e7feb222e43', '2ba5ed18-4804-592e-3495-2e5f0ee5c96a', '① Y종 — A종으 E종 — B종', '정답 ①. K3 절연물의 절연계급 종별 Y A E B F H C 최고허용 180 90 105 120 130 155 180 온되0C] 초과 1', array['산업안전기사','2023-3'])
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('284d1ca1-94cd-3475-8a4d-1734c26871a0', '37e4903d-dba1-3d85-7bb6-65108145b59a', '① 메탄 20[vol%], 에탄 30[vol%], 프로판 50[vol%]의 혼', '정답은 ① 입니다', array['산업안전기사','2023-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('4ed2e05f-91aa-bc10-3aa9-871bd5faf7a9', '1ae0b97d-49a5-26e1-62a3-9c2ebdb441df', '① 펌프의 회전수를 높인다.', '정답 ①. ES 공동현상은 유속이 빠를 경우 발생할 수 있으므로 공동현상을 예 방하려면 펌프의 회전수를 낮춰야 한다', array['산업안전기사','2023-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('4e236c54-0651-addf-9d61-db906f86e746', 'b66cbf97-7579-2cbe-f07c-8ada0668f8fa', '② 지붕트러스의 일체화 또는 지상에서 조립', '정답 ②. IBM 지붕트러스의 일체화 또는 지상에서 조립하는 경우 고소작업을 최소화할 수 있다', array['산업안전기사','2023-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('00281e0e-ddd7-77ef-9184-187dce4eba53', '7a4e835e-0a6d-d08e-8e65-333168eda4c7', '② 2명이상', '정답 ②. MEM 공사금액 800억 원 이상 1,500억 원 미만인 건설공사의 경우 안 전관리자는 2명 이상 배치하여야 한다. 다만. 전체 공사기간 중 전 • 후 15 에 해당하는 기간 동안은 1명 이상으로 한다. 5旧 아仏PTER 04 건설현장 안전시설 관리 10', array['산업안전기사','2023-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('6b15c3f6-81a5-f073-5251-16b1439327dc', '14bab536-afd3-0e25-3e28-a3d20f10d035', '③ 콘크리트펌프카', '정답은 ③ 입니다', array['산업안전기사','2023-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('ab5d4880-33be-828a-9462-dad1b453fd26', '92d28940-b19b-f5b4-8906-28949ba262f4', '④ 유로 폼(euro form)', '정답 ④. 작업발판 일체형 거푸집의 종류 • 갱 폼(Gang Form) • 슬립 폼(Slip Form) • 클라이밍 폼(Climbing Form) • 터널 라이닝 폼(Tunnel Lining Form)', array['산업안전기사','2023-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('40dfd443-4399-7f39-f790-13471788d85d', '06eb731b-5c45-b0d6-c821-ffd197205543', '③ 진동공법', '정답 ③. a 진동다짐 공법은 사질토 연약지반 개량공법이다. E <1', array['산업안전기사','2023-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('5006984a-b3dc-0b6a-24fd-ec462ce84606', 'c6277b84-2266-898e-6f80-65b8c987b57d', '④ 공사금액 100억 원 이상의 건설업의 경우 산업안전보', '정답 ④. 건위원회를 구성 • 운영해야 한다. KOi 건설업의 경우 공사금액 120억 원 이상（토목공사업의 경우에는 150억 원 이상）일 때 산업안전보건위원회를 구성 • 운영하여야 한다. 바剛t 아UPTER 01 산업재해예방 계획 수립 00', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('ef854532-a3c5-df4b-91ce-8403cc8f74b9', 'db6ce75f-3cc0-968e-d463-9875aa207b72', '① 긴급처리 一 재해조사一 원인분석 — 대책수립', '정답 ①. K^i 재해발생 시 조치순서 @ 긴급처리 © 재해조사 © 원인강구: 4M 요인 ©대책수립 @실시 @평가 EHm SUBJECT 03 기계 • 기구 및 설비 안전관리', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('6a6daeb4-aae3-a9ad-32bf-2e7c225f8465', '2bec1d49-2a0d-bca4-b50a-42465b2b36f6', '② 수시점검', '정답 ②. Ka 안전점검의 종류 종류 내용 일상점검 (수시점검) 작업 전 •중 •후 수시로 실시하는 점검 정기점검 정해진 기간에 정기적으로 실시하는 점검 기계 • 기구의 신설 및 변경 시 고장 수리 등에 의해 부정기 특별점검 적으로 실시하는 점검. 안전강조기간에 실시하는 점검 등 임시점검 이상 발견 시 또는 재해발생 시 임시로 실시하는 점검 SUBJECT 03 기계 • 기구 및 설비 안전관리', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('b8230229-7467-3c0a-3aa5-dfdf7d079224', '865a5bff-a1c5-2e1c-ed56-bc63c30be6bf', '④ 원재료, 중간제품', '정답 ④. S3 안전성 평가 제2단계(정성적 평가) • 설계관계: 입지조건. 공장 내 배치, 건조물, 소방설비. 공정기기 등 • 운전관계: 원재료. 운송. 저장 등 1', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('78e2ed45-864d-6156-3e68-3b655887655d', '524fb5cf-9f0e-db74-feb3-28243bc4c703', '② 방호장치의 기능을 변형 또는 보수할 때 양중기의 기능', '정답 ②. 어야 하며 양중기는 작동이 되지 않아야 한다. 다만, 크 레인은 과부하 상태 해지를 위하여 권상된 만큼 권하시 킬수 있다. 양중기 과부하방지장치의 일반적인 성능기준 방호장치의 기능을 제거 또는 정지할 때 양중기의 기능도 동시에 정지할 수 있는 구조이어야 한다. 밖組SI', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('475e1583-b598-19f7-0c96-274aabebd797', '138bafda-a7bf-224d-856c-5968fa84505a', '④ 동력식 수동대패기계: 반발예방장치', '정답 ④. K3 대패기계의 날접촉예방장치 사업주는 작업대상물이 수동으로 공급되는 동력식 수동대패기계에 날접촉 예방장치를 설치하여야 한다. 1', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('dfb40575-068d-3c89-8d1b-4bf87bc2bcf9', 'dbb0d717-0e12-5968-e3bd-f090e281cfc4', '② 도르래', '정답 ②. na 양중기의 종류 • 크레인（호이스트 （Hoist） 포함） • 이동식 크레인 • 리프트（이삿짐운반용 리프트의 경우에는 적재하중이 0.1 톤 이상인 것으 로한정） •곤돌라 •승강기 1', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('f95d1f84-58b5-dff3-3550-1f9367f5011f', 'c4f53d6c-8786-c2a7-03a6-f1244076f031', '① 45 [cm]', '정답 ①. 롤러의 표면속도 즈스^으느 56.5[m/min] 여기서. 刀： 롤러의 지름[mm] N： 분당회전쉬rpm] 급정지 거리 （끄 X 360） X흐느 452[mm] 이내 45[cm] 이내 급정지장치의 성능 앞면 롤러의 표면속되m/min] 급정지거리 앞면 롤러 원주의 : 이내 30 미만 앞면 롤러 원주의』〒 이내 30 이상', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('4711d6f0-1285-d0ff-3e5d-5615f5db47e4', 'de06c6fb-5120-143c-6d9f-3d7762eab2a6', '① 납', '정답 ①. KOI 압력방출장치는 매년 1회 이상 국가교정기관에서 교정을 받은 압력 계를 이용하여 설정압력에서 압력 방출장치가 적정하게 작동하는지를 검사한 후 납으로 봉인하여 사용하여야 한다', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('608e2907-c66f-f8ab-8bdc-6e1461abc31b', 'cf801658-a091-cd3a-324e-e14bb90ea9bb', '② 75럭스', '정답 ②. 3 근로자가 안전하게 통행할 수 있도록 통로에 75[lux] 이상의 채 광 또는 조명시설을 하여야 한다. 1', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('0f7d72f4-c7a3-85e1-d85d-c102ca67823d', 'cb94f73f-2f17-727a-3ea6-118d1bad7740', '③ ® 3.5[kV/m] 이하 ®83.3[/zT] 이하', '정답 ③. na 교류 특고압 가공전선로에서 발생하는 극저주파 전자계는 지표 상 l[m]에서 전계가 3.5[kV/m] 이하. 자계가 83.3[XT] 이하가 되도록 시 설하고. 직류 특고압 가공전선로에서 발생하는 직류전계는 지표면에서 25[kV/m] 이하, 직류자계는 지표상 l[m]에서 400,000[/T] 이하가 되도 록 시설하는 등 상시 정전유도 및 전자유도작용에 의하여 사람에게 위험을 줄 우려가 없도록 시설하여야 한다. 1 아1APTER 05 전기설비 위험요인관리', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('bcc1cc6a-d284-b631-7d1e-e1bbfc694d2f', 'b728f922-7ea3-88bf-f6c4-11a98f24d53c', '① 13.6', '정답은 ① 입니다', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('63ccf0b2-29c1-f862-4598-8ff3229381cd', 'd4748bcc-ab3f-8658-38e7-859ea7d4141a', '① 저압: 직류 l[kV] 이하', '정답 ①. KOi 전압의 구분 • 저압: 교류는 l[kV] 이하. 직류는 1.5[kV] 이하인 것 • 고압: 교류는 l[kV]를. 직류는 1.5[kV｝를 초과하고, 7[kV] 이하인 것 • 특고압: 7[kV]를 초과하는 것 EH 1', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('e2326f0f-d7e5-b647-bc39-76cf0cf9dc66', '1e052c14-a81d-c3bf-2342-84547b2b6980', '④ 반응폭주', '정답 ④. i 반응폭주 온도, 압력 등 제어상태가 규정의 조건을 벗어나는 것에 의해 반응속도가 자수함수적으로 증대되고. 반응용기 내의 온도. 압력이 급격히 이상 상승 되어 규정 조건을 벗어나고. 반응이 과격화되는 현상이다. 1', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('974cdd57-7f90-a391-8884-293bf3114da9', 'be53c559-6886-bea7-7070-c6e1aa154cda', '② 10[m]', '정답 ②. 3 단위공정시설 및 설비로부터 다른 단위공정시설 및 설비의 사이 는 설비의 바깥면으로부터 10[m] 이상의 안전거리를 두어야 한다. E묘', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('58664e89-386c-b7a7-255e-0f2f6c13de1f', 'c26494f6-edf9-c87b-8edd-acf79cb0d513', '② 증발열', '정답 ②. K찌 증발열 • 어떤 물질이 기화할 때 외부로부터 흡수하는 열량이다. • 증발열이 클수록 주변에서 더 많은 열을 빼앗으므로 주위의 온도를 낮추 게 된다. • 증발열은 냉각현상에 응용된다. 1', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('11b59e63-ca8f-7e38-a958-f12fe55a41e0', '3cfb250c-1f4e-4e2f-7dd2-9b62182ed8f0', '③ 30[cm]', '정답 ③. mi 근로자가 수직방향으로 이동하는 철골부재에는 답단 간격이 30[cm] 이내인 고정된 승강로를 설치하여야 한다', array['산업안전기사','2022-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
