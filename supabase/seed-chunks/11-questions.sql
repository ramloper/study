...
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('e28c875e-6e1d-0a9b-e941-311319c625ce','b48489e8-ba2c-4d6d-dfea-b9a745253f1d','① 기존 동일 제품을 기준으로 한 설계','정답 ①. 기존 동일 제품을 기준으로 한 설계',array['산업안전기사','2020-12'])
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('ed49b7a3-b617-3f08-9bcd-b64cdb2ecf3e','a96fd14c-f910-dacb-8139-448ca74be069','① 37[%]','정답 ①. 지게차 주행 시의 좌우 안정도(기준 무부하상태) 15+1.1V 15+1.1X2O 37[%] 이내 여기서. V: 구내 최고속되km/h] t색 81',array['산업안전기사','2020-12'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('a2cd863f-7fdf-ec1e-00ce-3684e2166207','0752c891-240c-fdb3-9aeb-25702df7882e','② 연암 및 풍화암 - 1 : 1.5','정답 ②. 연암 및 풍화암 - 1 : 1.5',array['산업안전기사','2020-12'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('68b05f20-d126-dd18-457a-e167e0eba232','c1f03e3e-cd2b-f9d3-eb44-b5789e6af13d','② 50[%] 이상','정답 ②. 공사진척에 따른 산업안전보건관리 비 사용기준 공정S%] 50 이상 70 미만 70 이상 90 미만 90 이상 사용기쥔%] 50 아상 70 이상 90 이상',array['산업안전기사','2020-12'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('cefc59fe-cbdb-3feb-0a79-685be5365bf7','4816a7e6-9a05-9a7c-ad62-10cd4d017172','① 노란색-정지신호, 소화설비 및 그 장소, 유해행위의','정답 ①. 안전보건표지의 색도기준 및 용도 색채 색도기준 용도 사용예 정지신호, 소화설비 및 그 장소. 유해 금지 행위의 금지 빨간색 7.5R4/14 화학물질 취급장소에서의 유해 • 위험 경고 경고 화학물질 취급장소에서의 유해 • 위험 노란색 5Y 8.5/12 경고 경고 이외의 위험경고. 주의표지 또는 기계방호',array['산업안전기사','2020-3'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('96a5a959-8402-d759-9f6b-0ab3546ef2a2','aae0cafc-87fb-9114-6aec-58ddc6ad6f30','④ 90[dB] 이상의 소음이 1일 8시간 이상 발생하는 작업','정답 ④. 90[dB] 이상의 소음이 1일 8시간 이상 발생하는 작업',array['산업안전기사','2020-3'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('d6d53019-fe1e-448f-9c1e-e70e0638b24a','91c5b938-51a0-f173-4e8f-b3b9b434cddb','① 숫돌의 정면에 서서 숫돌 원주면을 사용한다.','정답 ①. 숫돌의 정면에 서서 숫돌 원주면을 사용한다.',array['산업안전기사','2020-3'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('1df9060f-bc1e-cf1d-31b1-f34db80bbd72','b3ddd4b5-f461-ce5c-0854-094edcb75939','① 재질의 안전화','정답 ①. 기계의 안전조건 • 외형의 안전화 • 작업의 안전화 • 작업점의 안전화 • 기능상의 안전화 • 구조적 안전화(강도적 안전화) 8',array['산업안전기사','2020-3'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('62d5e1d4-5cca-d4c0-83d5-ceee9068c25d','ce46f521-afdd-25c9-738c-b08b8aa40f38','④ 선반의 바이트는 끝을 길게 장치한다.','정답 ④. 3B 선반작업 시 바이트는 끝을 짧게 장치하고 일감의 길이가 직경의 12배 이상일 때 방진구를 사용한다',array['산업안전기사','2020-3'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('7420dfd1-4424-94b9-f556-d514fceecab6','9d77dd74-c6b4-96f2-ae62-6714106edbec','① 사이클론, 백필터. 전기집진기 등분진처리설비','정답 ①. 사이클론. 백필터(Bag Filter). 전기집진기 등 분진처리설비는 화학설비의 부속설비에 해당한다. 오답해설 0, . 는 화학설비에해당한다',array['산업안전기사','2020-3'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('9c87ca84-4539-8d8e-1fb6-6f7d327cb821','11d1083a-9e42-39d5-1db0-ad9bfe417a82','③ 주된 소화효과는 억제소화이다.','정답 ③. 이산화탄소소화기는 질식소화가 주된 소화효과이며. 냉각효과를 동반하여 상승적으로 작용하여 소화한다. kWil뢬',array['산업안전기사','2020-3'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('83002e68-abe7-8017-e6aa-bfb3839a4c6e','38094c80-5c4f-0bbf-100b-66c0a14f58b2','② A： 4, B： 10, C： 10','정답 ②. A： 4, B： 10, C： 10',array['산업안전기사','2020-3'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('0df632a3-0f11-d9da-b74b-ed447324f05f','be305362-cd82-4bbf-e069-05e5ba0e1913','③ 시스템이 고장나지 않도록 하는 사상의 조합이다.','정답 ③. 시스템이 고장나지 않도록 하는 사상의 조합이다.',array['산업안전기사','2020-4'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
...
on conflict (id) do update set body=excluded.body;
insert into public.question_answers (question_id,correct_option_id,answer_text,explanation,concepts) values
 ('0d71686b-f551-6dfe-6b35-a3141a420b0c','48a6ca88-0b8a-18a2-83fa-d35e1b7a089c','③ 2배','정답 ③. 2배',array['산업안전기사','2020-4'])
on conflict (question_id) do update set correct_option_id=excluded.correct_option_id, answer_text=excluded.answer_text, explanation=excluded.explanation, concepts=excluded.concepts;
