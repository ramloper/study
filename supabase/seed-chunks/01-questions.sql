-- chunk 1/14 questions 40 (산업안전기사)
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('6169f163-1fc5-3f6a-4151-9f07e49d667d', 'bf9160da-87d6-e3d9-f4b6-b01af32d3851', '① 동일화', '정답 ①. 동일화(identification) 다른 사람의 행동양식이나 태도를 투입시키거나 다른 사람 가운데서 자기 와 비슷한 점을 발견하는 것이다', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('af702af6-e205-9e10-65b6-db87cef86dd4', '8026384f-de36-ec9d-4e2b-3596de1861b4', '① 재현성', '정답 ①. 직무적성검人K심리검사）의 특징 신뢰성. 객관성, 표준화. 타당성, 실용성 1 아仏PTER 03 산업안전심리 01', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('5f50b6aa-5899-ee15-b213-69e5f13619f1', 'bce903af-efad-021e-9496-d8dfdfc5b1b7', '② 안전에 대한 욕구', '정답 ②. OI 매슬로우（Maslow）의 욕구위계이론 0 제1단계 : 생리적 욕구 © 제2단계: 안전의 욕구 © 제3단계 : 사회적 욕구（친화 욕구） ⑪ 제4단계 : 자기존경의 욕구（안정의 욕구 또는 자기존중의 욕구） @ 제5단계 : 자아실현의 욕구（성취욕구） 【토', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('297b293d-5e44-0b9e-910b-3d32ce502640', '366b4171-dce7-1de9-fbf3-61d56c4cf44f', '③ Beta 1', '정답 ③. 셰보느 신호검출이론(SDT； Signal Detection Theory) 배경소음(Noise)이 신호검출에 미치는 영향에 관한 이론으로 기준점에서 두 곡선의 높이의 비(신호/소음)를 匕라고 하며, 두 정규분포 곡선이 교차하 는 부분에 판별기준이 놓였을 경우 匕 1이다. WHIWI', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c72c4b96-c0e3-ac07-bb54-591a92c2a544', '57aba7e8-75aa-65fe-20af-a57ef8f76ba3', '② 3배', '정답 ②. K^ NIOSH Lifting Guideline에서 중량물 취급 시 감시기준(활 동한계. AL)과 최대허용기준(MPL)의 관계식은 다음과 같다. MPL 3AL BWil팈I', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('437d9bde-eb0e-fab0-d38b-f5346853ce09', '72a4ddc0-418d-cc45-5700-0984da03aa9f', '④ 책임추궁을 우선으로 한다.', '정답 ④. S 재해조사 시 책임추궁보다는 재발방지를 우선하는 기본 태도를 갖는다. 1W1M', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('79fac8b9-1408-bc02-b758-999fc1d66662', '3a44143e-f9fb-f76a-c8ae-3d5247c9aa45', '③ 인장시험', '정답 ③. K^B 인장시험은 파괴시험의 일종이다. 비파괴검사의 종류 방사선투과시험 (RT). 초음파탐상검사(UT). 자분 탐상검사(MT). 침투탐 상검사(PT). 음향탐상검사(AET), 와류탐상검사｛ECT) 등 1', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('dd8db9be-568d-9d08-0c19-bafcebeddd80', '3a9fc70c-bc1f-d367-00b6-4e6c9a326e81', '③ 심실의 휴식 시 발생하는 파형', '정답 ③. Kai 丁파 심실의 수축 종료 후 심실의 휴식 시 발생하는 파형으로 전격이 인가되면 심실세동을 일으키는 확률이 가장 크고 위험한 부분이다. W 1 아1APTER 02 감전재해 및 방지대책 2025년 1회 CBT 복원문제 • 19 06', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('38cedacf-cfd1-5528-3836-0c9033ab7dbf', 'b88b9631-5c81-ae69-2961-533b12b604fd', '② 폭발성 분위기에 있는 용기의 접합면 틈새를 통해 화염', '정답 ②. 그것이 점화원으로 작용하지 않도록 화염의 에너지를 억제하여 폭발하한계로 되도록 화염 크기를 조정하는 한계치 짜느 화염일주한계（최대안전틈새, MESG） 폭발성 분위기 내에 방치된 표준용기의 접합면 틈새를 통하여 폭발화염이 내 부에서 외부로 전파되는 것을 저지（최소점화에너지 이하）할 수 있는 틈새의 최대간격치이며 폭발성 가스의 종류에 따라 다르다. 1', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('9c31e762-7e22-cd91-d7b8-ee69ec560369', '3093b7a0-af73-f694-b794-9f80831ddc80', '② 절연이 불량인 경우 접지저항을 측정한다.', '정답 ②. E9 절연이 불량인 경우 절연저항을 측정하여 조치를 하여야 한다', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('05b88569-e4cd-2454-3162-35c09ce96cfe', '302a6f19-ad88-f7ee-3c4c-4ee320d7efef', '② 13.6', '정답 ②. OI 形 /2/?T (淨X1O-3)2X5OOT (1652 x 10^6)x500 13.6[J] 여기서. 印： 위험한계에너지U] /： 심실세동전류[A] Z?： 인체저항[Q] T： 통전시갠s] E IO 아仏PTER 02 감전재해 및 방지대책 06', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('f0e750a3-cbe1-4bf0-12e6-8b0dfee56ff1', 'e2d0b1be-631a-86de-6cfc-fc5ee512bc67', '③ 인가전압의 크기', '정답 ③. KSI 인체의 피부 전기저항은 인체의 각 부위（피부. 혈액 등）의 저항성 분과 용량성분이 합성된 값이 되며. 이 값은 여러 인자. 특히 접촉전압. 통 전시간. 접촉면적 등에 따라 변화한다. 1', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('ee21f7f4-3252-4c35-bed5-1d4598477962', '456a2131-ccb6-041f-412c-cc833ec2e74f', '② 점화원의 방폭적 격리', '정답 ②. W 전기설비의 방폭화 • 점화원의 방폭적 격리(압력방폭, 유입방폭, 내압방폭) • 전기설비의 안전도 증강(안전증방폭) • 점화능력의 본질적 억제(본질안전방폭)', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('cba33d45-9e4d-c1e3-aaf3-d96279cfe3d0', '1ff0c6c1-b112-7140-6c94-38de7912ce6b', '① 탄화칼슘은 물속에 저장한다.', '정답 ①. 9 탄화칼슘(CaC2, 카바이드)은 물과 반응하여 인화성 가스인 아세 틸렌(CJL)을 발생시키므로 물속에 저장을 금지한다. CaC2+2H2O - Ca(OH>2+C2H21 EHEItn', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('596e42f7-7b61-096f-dc74-133564404f8e', '25931ee5-87da-4dc9-895b-94c73e67c4f2', '③ 타워크레인', '정답 ③. Ea 낙하물 보호구조를 갖추어야 하는 차량계 건설기계 불도저. 트랙터. 굴착기, 로더, 스크레이퍼. 덤프트럭. 모터 그레이더. 롤러, 천공기. 항타기 및 항발기 ◎H回', array['산업안전기사','2025-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('fa0e29ca-4d33-4e67-2e1f-498c593eb240', 'ada48f42-3b58-3459-5320-e5779f842e18', '③ 600건', '정답 ③. K9 하인리히의 재해구성비율 중상 또는 사망 : 경상 : 무상해사고 1 : 29 : 300 경상 : 무상해사고 29 : 300이므로 무상해사고 58 乂 쯔 600건 아UPTER 01 산업재해예방 계획 수립 00', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('47751e9d-3d22-f88f-ab66-a31de6b01b5f', '6fae0b88-c8c7-ff29-4e24-f6a01c466744', '② 기능교육', '정답 ②. I H 瓦^ 기능교육 • 교육대상자가 그것을 스스루 행함으로 얻어진다. • 개인의 반복적 시행착오에 의해서만 얻어진다. • 시험. 견학, 실습. 현장실습 교육을 통한 경험 체득과 이해를 한다. ▽', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('8e5f1a87-f6df-0260-191b-904ecc7ded1f', 'f6b8007c-0ad3-b647-1902-9babfd62f28c', '④ 의견을 발언할 때에는 주어진 요건에 맞추어 발언한다.', '정답 ④. KOI 브레인스토밍（Brain Storming） • 비판금지: “좋다. 나쁘다” 등의 비평을 하지 않는다. • 자유분방: 자유로운 분위기에서 발표한다. • 대량발언: 무엇이든지 좋으니 많이 발언한다. • 수정발언: 자유자재로 변하는 아이디어를 개발한다.（타인 의견의 수정발 언） E B1', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c149c105-44d1-d4a6-f471-63a23f9b1c44', '538d14ba-0766-89b0-122d-7c523674070f', '③ 출입구', '정답 ③. a 출입구는「산업안전보건법령」상 안전보건표지에 해당하지 않는다. 녹십자표지 응급구호표지 들것 세안장치 비상용기구 비상구 좌측비상구 우측비상구 A 안내표지의 종류', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('1a75ef8e-8e29-ad70-7fa2-b252a4160750', '1aa5366b-b055-7968-7e0b-6bcb14c0037b', '② C/R 비율을 1보다 낮게 조절하여야 한다.', '정답 ②. 3 승비가 작을수록 조정이 어려워 조정장치가 민감하나 이동시간 이 짧으므로. 정확도보다 속도가 중요하다면 음•비를 1보다 낮게 조절하 여야 한다', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('5745703c-b324-8e93-169d-80ad3020e860', 'bbb2d947-e6ca-f177-c9bf-0f7d4fa786ec', '① 0.225［시간/회］', '정답 ①. « 평균수리시간(MTTR； Mean Time To Repair) 총 수리시간을 그 기간의 수리횟수로 나눈 시간으로 사후보전에 필요한 수 리시간의 평균치를 나타낸다. MTTR 수릿米퉀계 0丄 + 0門0.3 + 0.흐 0.225[시간/회] 수리횟수 4 1', array['산업안전기사','2025-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
