-- chunk 3/14 questions 40 (산업안전기사)
...
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('7a5e21e8-3e70-0207-b47f-d9faee9edf4e', '105c27cd-7abf-7d91-ec2b-66123e3529b0', '① 원심펌프', '정답 ①. 서 액체의 열팽창에 의하여 파열될 우려가 있는 것으로 한정함） m r산업안전보건법령상 원심펌프는 안전밸브의 설치대상이 아니다. 1', array['산업안전기사','2025-3'])
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c7485d8f-19f9-3b82-4b23-8d467ec69052', '1062abde-7ae8-4808-81db-1f0cb75eb0db', '③ 지름의 감소가 공칭지름의 5[%]를 초과하는 것', '정답 ③. KS 달비계 와이어로프의 사용금지 조건 •이음매가있는 것 • 와이어로프의 한 꼬임(Strand)에서 끊어진 소선의 수가 10[%] 이상인 것 • 지름의 감소가 공칭지름의 7[%]를 초과하는 것 •꼬인것 • 심하게 변형되거나 부식된 것 • 열과 전기충격에 의해 손상된 것 1', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('63434760-db37-aa41-1087-baf9c0df68da', 'a3bd9345-4ed1-6f8e-4560-e90bafdffcb6', '① 어스드릴', '정답 ①. KHB 어스드릴은 차량계 건설기계에 해당한다. 양중기의 종류 • 크레인(호이스트(Hoist) 포함) • 이동식 크레인 • 리프트(이삿짐운반용 리프트의 경우에는 적재하중이 0.1 톤 이상인 것으 로한정) •곤돌라 •승강기', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('ac804284-479b-2618-9100-d62badcd8954', '4bcaa3ad-a6cd-7385-52c6-6dfa8488c5d2', '④ 6개월', '정답 ④. m 도급인은 산업안전보건관리비 사용내역에 대하여 공사 시작 후 6개월마다 1회 이상 발주자 또는 감리자의 확인을 받아야 한다. 다만. 6개월 이내에 공사가 종료되는 경우에는 종료 시 확인을 받아야 한다. E I?1 아UPTER 03 건설업 산업안전보건관리비 관리 82 • 산업안전기사 필기 기출문제편 11', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('7f7a8d83-5174-9719-7a2a-f62e608c4ce5', '4d31ffc4-8c88-8ad8-935e-90d7b2d12d1b', '② 1 ： 1.0', '정답 ②. 굴착면의 기울기 기준 지반의 종류 굴착면의 기울기 모래 1 : 1.8 연암 및 풍화암 1 : 1.0 경암 1 ：0.5 그 밖의 흙 1 : 1.2 E早', array['산업안전기사','2025-3'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('efcb7722-049d-426f-f792-7389fac70f02', '475e7e5f-4009-5866-1f77-d31364246eb9', '① 검은색-금지', '정답 ①. «厄» 안전보건표지의 색도기준 및 용도 색채 색도기준 용도 사용예 정지신호 소화설비 및 그 장소. 유해 금지 행위의 금지 빨간색 7.5R4/14 화학물질 취급장소에서의 유해 • 위험 경고 경고 화학물질 취급장소에서의 유해 • 위험 노란색 5Y 8.5/12 경고 경고 이외의 위험경고. 주의표지 또는 기계방호물 파란색 入5pB 4/10 지시 특정 행위의 지시 및 사실의 고지 비상구 및 피난소. 사람 또는 차량의 녹색 Z5G 4/10 안내 통행표지 아仏PTER 02 안전보호구 관리 86 • 산업안전기사 필기 기출문제편 00', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('4f44b3cd-2481-7730-f972-8f87843040d3', '84742727-48f6-eb99-d127-e3dc1191e3e8', '② 안전에 관한 지시나 조치가 신속하다.', '정답 ②. 간과 노력이 소모된다. KOI 라인형（직계형） 조직은 안전에 관한 지시 및 명령계통이 철저하 고（생산라인을 통해 이루어짐）. 안전대책의 실시가 신속하다. !WI 아MPTER 01 산업재해예방 계획 수립 00', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('7c9155fa-d09a-1c21-2bfb-049d0a63f82d', '3a85efff-c4db-0e32-9829-51206188342a', '③ 제 3단계: 전술적 에러', '정답 ③. K9 애드워드 아담스(E. Adams)의 사고연쇄반응 이론 O 1단계: 관리구조 결함 © 2단계 : 작전적 에러 一 관리자의 의사결정이 그릇되거나 행동을 안 함 © 3단계: 전술적 에러 一 불안전 행동. 불안전 동작 ⑪ 4단계 : 사고 一 상해의 발생. 아차사고(Near Accident). 비상해사고 단계: 상해. 손해 一 대인, 대물 5圓', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('a0132c58-5a47-3871-7236-ebd82ff6b87d', '2379c5af-09aa-9f1a-a3ab-b1f38d2711fa', '③ 준비성의 원리', '정답 ③. 3 ‘준비성’에 관한 것은 손다이크(Thorndike)의 시행착오설 중 ‘준비성의 법칙 ’에 해당한다. 파블로프(Pavlov)의 조건반사설 • 계속성의 원리(The Continuity Principle) • 일관성의 원리(The Consistency Principle) • 강도의 원리(The Intensity Principle) • 시간의 원리(The Time Principle) 1', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('30b6e1bc-7870-1c98-8e2f-ae449abeb8e9', '68b047cf-be23-d0c4-648f-bd7b6e3cfbb1', '③ 안전보건 향상을 위해 참고할 수 있는 기술적 내용을', '정답 ③. W 기술지원규정(KOSHA GUIDE) '' 산업안전보건법령」에서 정한 최소한의 수준이 아니라. 사업장의 자기규율 예방체계 확립을 지원하고. 좀 더 높은 수준의 안전보건 향상을 위해 참고 할 수 있는 기술적 내용을 기술한 자율적 안전보건가이드이다. 풰릐', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('7914f468-0350-876a-9fb2-af76dc5c31b7', '317f7e6d-3e18-4ae2-b82a-3d2586a35d4c', '③ 계속성의 원리', '정답 ③. K9I 계속성의 원리는 학습지도의 원리가 아닌 파블로프의 조건반사 설에 해당한다. 학습지도 이론 개별화의 원리, 통합의 원리. 사회화의 원리. 자발성의 원리, 직관의 원리 1', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('bb9f89c5-1809-e63b-d3f0-baed3d817c8d', '7355aea3-3656-cefa-60f7-4849e628ecc6', '① 휴식계수', '정답 ①. 亞 NLE(NIOSH Lifting Equation) 권장무게한계 (RWL) 23 xHMxVMxDMxAMxFMxCM 여기서. HM： 수평계수. VM： 수직계수, DM： 거리계수. AM： 비대칭계수, FM: 빈도계수, CM: 커플링계수 1', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('827910d7-a2b4-f4f3-e48d-3cb82eb986cf', 'dee22a87-9995-3509-69bc-0afb5f15cfd6', '② 아웃트리거', '정답 ②. a 보일러의 폭발사고를 예방하기 위하여 압력방출장치. 압력제한 스위치. 고저수위 조절장치, 화염검출기 등의 기능이 정상적으로 작동될 수 있도록 유지 • 관리하여야 한다', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('3246dc1b-d72b-feaf-ea66-52d26de168fb', '975d15cd-4b42-2156-02bb-20f8f1e3e274', '① 24', '정답 ①. 양수기동식 방호장치 안전거리 A 1,600 x 7三 1.600 x 0.15 240[mm] 24[cm] 여기서. Tm： 누름버튼을 누른 때부터 슬라이드가 하사점에 도달할 때까지 의 소요 최대시간[초]', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('bccb04d0-9aa4-d751-44a9-0a015472a874', 'd8971418-4bcd-590b-c2ff-fbe773b1d755', '④ 금속탐지기', '정답 ④. K 찌 유해 • 위험 방지를 위하여 방호조치가 필요한 기계 • 기구 예초기. 원심기. 공기압축기. 금속절단기. 지게차. 포장기계（진공포장기. 래 핑기로 한정） 1', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c26639c0-72b0-36b4-2fdf-ebdb477bc30a', '9cb9dd9e-cb66-b5ef-4bc0-7d7226e77ed1', '② 운반하는 경우에는 캡을 벗길 것', '정답 ②. 3 금속의 용접 • 용단 또는 가열에 사용되는 가스 등의 용기를 운반 하는 경우에는 캡을 씌워야 한다', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c64d2a10-e571-5674-c1c1-2561b85871e9', '1fe67c91-bde1-dbe3-c5f1-5150693eaa89', '① 연삭기', '정답 ①. a 연삭기는 안전인증대상이 아닌 자율안전확인대상 기계 • 기구이다. 안전인증대상 기계 • 기구 및 설비 프레스. 전단기 및 절곡기. 크레인. 리프트, 압력용기. 롤러기. 사출성형기. 고소작업대. 곤돌라', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('30ab0ba9-99aa-7555-f316-31717da856ad', 'eadb6be3-316c-325c-923f-9e55c7b7d091', '③ 202', '정답 ③. 國흽 허용접촉전압 凡+쪼） E （ x 八 （1,000+으씅의） x 0.165 202[V] 여기서. 凡: 인체저해Q] 10s: 지표상층 저항률[fl • m] A： 통전전류[A] 아UPTER 02 감전재해 및 방지대책', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('420ff15c-6112-daab-a554-3d33e82790de', '09cc6ab9-6175-ff87-6bb0-378e7cbfa33a', '① OCB', '정답 ①. W씨I 유입차단기（OCB； Oil Circuit Breaker） 전기회로를 개폐하는 차단기의 일종으로. 차단 부분이 절연유 속에 들어가 있어 오일차단기라고도 부른다. 오답해설 ELB（Earth Leakage Breaker）： 누전차단기 VCB（Vacuum Circuit Breaker）： 진공차단기 MCCB（Molded Case Circuit Breaker）： 배선용 차단기 ,', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('a1d28050-0526-0ec2-9095-160e42d83f53', '79a6b325-1a98-f54a-8151-3b2ae4363d1d', '② 각 단로기를 개방한 후 전원 차단', '정답 ②. 충전되어 있는지 확인 K9 전원을 차단한 후 각 단로기 등을 개방하고 확인하여야 한다. 1 아UPTER 02 감전재해 및 방지대책 07', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('c33c0b92-9556-d4cf-e192-3663e062534d', '3a5db05d-2d46-161b-6e0b-58742a8ae33f', '① C2F4Br2', '정답 ①. 2402는 구성 원소 중 C 2개. F 4개, C1 0개, Br 2개, I 0개이다. 따라서 Halon 2402의 화학식은 GFaBn이다. 1', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('d34e2e22-dbf0-eb44-7459-cd756c817cc7', '8ed00d5f-d4e7-1274-4c56-62fe974c8e8e', '③ 60°', '정답 ③. K3 타워크레인을 와이어로프로 지지하는 경우 와이어로프 설치각도 는 수평면에서 60° 이내로 하되, 지지점은 4개소 이상으로 하고. 같은 각도 로 설치하여야 한다. 폐SI', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('241aec3e-c679-1dae-6102-71576b554b4b', '0d9a11f1-0414-0329-3af2-b3c2ee0d5191', '③ 자율안전관리업체 유해위험방지계획서 제출 - 심사 면제', '정답 ③. na 유해위험방지계획서 확인사항 • 유해위험방지계획서의 내용과 실제공사 내용이 부합하는지 여부 • 유해위험방지계획서 변경내용의 적정성 • 추가적인 유해 - 위험요인의 존재 여부 E ?l', array['산업안전기사','2024-1'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('1e445429-a7fe-306d-6a71-45149903f73b', '89757dab-830a-c79a-5475-0b91a8ae757e', '② B형', '정답 ②. K 찌 길포드의 Y-G 성격검사 프로필 유형 • A형（평균형）: 조화적, 적응적 • B형（우편형）: 정서불안적, 활동적, 외향적 • C형（좌편형）: 안전소극형 • D형（우하형）: 안정, 적응. 적극형 • E 형（좌하형）: 불안정, 부적응, 수동형 1', array['산업안전기사','2024-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('5e9ce289-3b12-52e7-60ad-503c0062763f', 'bc6c4faf-2b93-d8b6-9e4c-09b370bf9fa2', '② 직업성 질병자가동시에 5명 이상 발생한 재해', '정답 ②. K9 중대재해의 범위 • 사망자가 1명 이상 발생한 재해 • 3개월 이상의 요양이 필요한 부상자가 동시에 2명 이상 발생한 재해 • 부상자 또는 직업성 질병자가 동시에 10명 이상 발생한 재해 WEIH 아仏PTER 01 산업재해예방 계획 수립 02', array['산업안전기사','2024-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('aac70f7b-6567-0969-9468-b9cf52a80531', '2939dedd-3e40-0f58-b0f2-056560e50ea6', '④ 수용가능(Acceptable)', '정답은 ④ 입니다', array['산업안전기사','2024-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
...
on conflict (id) do update set body = excluded.body, sort_order = excluded.sort_order;
insert into public.question_answers (question_id, correct_option_id, answer_text, explanation, concepts) values
  ('abc36319-c16f-0171-493c-71eda1f117cb', '2850fbe6-393a-db22-a154-0e8e5965c67c', '① 금형 가공작업', '정답 ①. KOI 프레스 등의 금형을 부착 • 해체 또는 조정하는 작업을 할 때에 해당 작업에 종사하는 근로자의 신체가 위험한계 내에 있는 경우 슬라이드 가 갑자기 작동함으로써 근로자에게 발생할 우려가 있는 위험을 방지하기 위하여 안전블록을 사용하는 등 필요한 조치를 하여야 한다. 1', array['산업안전기사','2024-2'])
on conflict (question_id) do update set
  correct_option_id = excluded.correct_option_id,
  answer_text = excluded.answer_text,
  explanation = excluded.explanation,
